...
// 科目配置
const SUBJECTS: Record<string, { name: string; maxScore: number; startYearOffset: number; endYearOffset: number; endMonth: number; endDay: number }> = {
